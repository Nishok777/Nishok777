...
function Adminlogin({ onLogin }) {
    ...
    const lhandleSubmit = async (event) => {
        ...
        try {
            ...
            if (lemail === 'nishokmadhavan2004@gmail.com' && lpassword === '12345') {
    ...
    return (
        <div>
            <form className="form" onSubmit={lhandleSubmit}>
                <h1 style={{ fontFamily: '' }}>ADMIN LOGIN</h1>
                ...
                <div className="flex-row">
                    ...
                    <button className="btn apple" onClick={() => navigate('/login')}>User Login</button>
                </div>
            </form>
            <Toaster
                position="top-right"
