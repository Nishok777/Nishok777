...
const Adminswap = () => {
    ...
    const { addShirt, addPant, addTshirt, addTrousers, addSuite } = useProducts(); // Use context
    ...
    return (
        <MainContainer>
            ...
            <DrawerContainer variant="temporary" open={drawerOpen} onClose={handleDrawerToggle}>
                ...
                <Divider />
                <List>
                    <ListItem button onClick={() => handleOpenModal('shirt')}>
                        <ListItemText primary="Add New Shirt" />
                    </ListItem>
                    <ListItem button onClick={() => handleOpenModal('pant')}>
                        <ListItemText primary="Add New Pant" />
                    </ListItem>
                    <ListItem button onClick={() => handleOpenModal('tshirt')}>
                        <ListItemText primary="Add New T-Shirt" />
                    </ListItem>
                    <ListItem button onClick={() => handleOpenModal('trouser')}>
                        <ListItemText primary="Add New Trousers" />
                    </ListItem>
                    <ListItem button onClick={() => handleOpenModal('suite')}>
