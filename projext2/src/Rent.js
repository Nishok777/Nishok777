...
const Buy = () => {
    ...
    return (
        <MainContainer>
            ...
            <ContentContainer>
                <Toolbar />
                <div ref={shirtRef}><Shirts category="rent" /></div>
                <div ref={pantRef}><Pant category="rent" /></div>
                <div ref={tshirtRef}><Tshirt category="rent" /></div>
                <div ref={trousersRef}><Trousers category="rent" /></div>
                <div ref={suiteRef}><Suite category="rent" /></div>
            </ContentContainer>
