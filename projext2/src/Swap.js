...
const Buy = () => {
    ...
    return (
        <MainContainer>
            ...
            <ContentContainer>
                <Toolbar />
                <div ref={shirtRef}><Shirts category="swap" /></div>
                <div ref={pantRef}><Pant category="swap" /></div>
                <div ref={tshirtRef}><Tshirt category="swap" /></div>
                <div ref={trousersRef}><Trousers category="swap" /></div>
                <div ref={suiteRef}><Suite category="swap" /></div>
            </ContentContainer>
